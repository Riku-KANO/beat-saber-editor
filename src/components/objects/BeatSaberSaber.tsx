...
function BeatSaberSaber({ object, currentTime, isPreview = false, isEditor = false }: Props) {
              ...
              >
                ...
                <mesh position={[0, 1.5, 0]}>
                  ...
                  <meshStandardMaterial 
                    ...
                    transparent 
                    opacity={opacity}
                    emissive={object.color === 'red' ? '#ff4444' : '#4444ff'}
                    emissiveIntensity={isCurrentFrame ? 0.5 : 0.3}
                  />
                </mesh>
